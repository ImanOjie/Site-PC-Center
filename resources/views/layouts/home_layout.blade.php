...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/shop_storage/pc-center.png">
    ...
    <div class="site-navbar site-navbar-target js-sticky-header">
        <div class="container">
            <div class="col-2 float-lg-right">
                <img src="/shop_storage/pc_center-2.png" width="100px" alt="" style="float: right">
            </div>
            <div class="row ">
                <div class="col-10">
